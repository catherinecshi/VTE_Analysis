...
class Betasort:
    ...
    def choose(self, chosen, unchosen, vte=False):
        """
        ...
        #uncertainty = uncertainty * (chosen_reward_hist / (unchosen_reward_hist + chosen_reward_hist))
    ...
    def choose_ti(self, chosen, unchosen, vte=False):
        """
        selects a stimulus from presented stimuli in a given trial
        ...
        """
            ...
            #self.tau = 1
        self.tau = 1
        if chosen == 0 and unchosen == 4:
            uncertainty = 0.75
        elif chosen == 3 and unchosen == 4:
            uncertainty = 0.85
        elif chosen == 1 and unchosen == 3:
            uncertainty = 0.75
        else:
            uncertainty = 1
        #uncertainty = self.get_uncertainty_ROC(chosen, unchosen)
